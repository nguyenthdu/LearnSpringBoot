...
public class UserServiceTest {
    ...
    void createUser_validRequest_success() {
        //xay dung test
        // GIVEN - tao du lieu
        when(userRepository.existsByUsername(anyString())).thenReturn(false);//false thi thuc hien cac buoc kiem tra tiep theo
    ...
    void createUser_userExisted_fail() {
        //xay dung test
        // GIVEN - tao du lieu
        when(userRepository.existsByUsername(anyString())).thenReturn(true);// true bat ngay vi tri nay nen khong can thuc hien cac buoc kiem tra tiep theo
        // WHEN - thuc hien
